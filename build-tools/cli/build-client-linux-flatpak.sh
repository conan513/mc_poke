...
# ════════════════════════════════════════════════════════════════════════════════
# COBBLEMON UNIVERSE - Client Flatpak Build Script
...
print_header() {
    echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║${NC} COBBLEMON UNIVERSE - Flatpak Build"
    echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
}
...
print_info "Flatpak build indítása..."
npm run dist:flatpak

if [ -f "web-installer/releases"/*.flatpak ]; then
    print_success "Flatpak build kész!"
    echo ""
    echo -e "${GREEN}Kész Flatpak csomag:${NC}"
    ls -lh web-installer/releases/*.flatpak
else
    print_warning "Nem található Flatpak fájl"
fi
