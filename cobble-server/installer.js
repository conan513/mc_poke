...
const EXTRA_MODS = [
  ...
  { slug: 'maplink',                        loaders: ['fabric'], gameVersions: [MC_VERSION] },
  { slug: 'player-mobs',                    loaders: ['fabric'], gameVersions: [MC_VERSION] },
  { slug: 'zombified-player',               loaders: ['fabric'], gameVersions: [MC_VERSION] },
  { slug: 'ordered-player-list',            loaders: ['fabric'], gameVersions: [MC_VERSION] },
  { slug: 'vmp-fabric',                     loaders: ['fabric'], gameVersions: [MC_VERSION] },
  { slug: 'squaremap',                      loaders: ['fabric'], gameVersions: [MC_VERSION] },
